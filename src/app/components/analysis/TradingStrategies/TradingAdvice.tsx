...
const TradingAdvice: React.FC<TradingAdviceProps> = ({
  ...
  const marketAnalysis = {
    ...
    sentiment: marketCondition.includes('上漲')
      ? 'bullish'
  ...
  const scenarioAnalysis = [
    {
      ...
      description: topStrategy
        ? `${topStrategy.type}策略按預期發展`
        : '技術指標配合良好',
      expectedReturn:
        topStrategy?.signal === 'bullish'
          ? '+8-15%'
          : topStrategy?.signal === 'bearish'
            ? '避免-5-10%損失'
            : '+3-8%',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/30 dark:to-cyan-900/30 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center space-x-2">
            <span
              className={`px-2 py-1 rounded-full text-sm font-medium ${getSentimentColor(marketAnalysis.sentiment)}`}
            >
            ...
            <div key={index} className="flex items-start space-x-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <div className="flex items-center space-x-2">
                    <span
                      className={`px-2 py-1 rounded text-xs font-medium border ${getPriorityColor(step.priority)}`}
                    >
                ...
                <div>
                  ...
                  <span
                    className={`ml-2 text-sm font-medium ${
                      scenario.expectedReturn.includes('+')
      ...
      <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-lg p-4">
        <div className="flex items-start">
          <div className="text-green-600 dark:text-green-400 text-xl mr-3">
            ✅
          </div>
          <div className="flex-1">
            <h6 className="text-sm font-semibold text-green-800 dark:text-green-200 mb-3">
              操作前檢查清單
            </h6>
